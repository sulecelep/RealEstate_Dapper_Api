...
namespace RealEstate_Dapper_Api.Repositories.WhoWeAreDetailRepository
{
    public class WhoWeAreDetailRepository : IWhoWeAreDetailRepository
    {
        ...
        public async void CreateWhoWeAreDetail(CreateWhoWeAreDetailDto createWhoWeAreDetail)
        {
            ...
            parameters.Add("@description1", createWhoWeAreDetail.Description1);
            parameters.Add("@description2", createWhoWeAreDetail.Description2);
